                        ...
                        <!--begin::Row-->
													<div class="row m-0">
														<div class="col bg-white px-6 py-8 rounded-xl mr-7 mb-7">
															...
															<a href="#" class="text-info font-weight-bold font-size-h6">Sales Products</a>
                                                            <h2>{{$total_sales}}</h2>
														</div>
														<div class="col bg-white px-6 py-8 rounded-xl mb-7">
															...
															<a href="#" class="text-warning font-weight-bold font-size-h6 mt-2">Users</a>
                                                            <h2>{{$total_user}}</h2>
														</div>
                                                    ...
                                                    <div class="row m-0">
														<div class="col bg-white px-6 py-8 rounded-xl mr-7">
															...
															<a href="#" class="text-danger font-weight-bold font-size-h6 mt-2">Category</a>
														...
														<div class="col bg-white px-6 py-8 rounded-xl">
															...
															<a href="#" class="text-success font-weight-bold font-size-h6 mt-2">Products</a>
